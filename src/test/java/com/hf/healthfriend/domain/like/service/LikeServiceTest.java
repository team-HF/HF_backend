...
class LikeServiceTest {
    ...
    void addLike_fail() {
        ...
        LikeDto duplicateLikeDto = new LikeDto(
                this.sampleMembers.get("member1").getId(),
                this.samplePosts.get("post1").getPostId()
        );

        assertThatExceptionOfType(DuplicateLikeException.class)
                .isThrownBy(() -> this.likeService.addLike(duplicateLikeDto));
    }
    ...
    void getLike_success() {
        ...
        Long autogeneratedLikeId = this.likeService.addLike(likeDto);

        LikeDto result = this.likeService.getLike(autogeneratedLikeId);
    ...
    void getLikeOfPost_success() {
        ...
        List<LikeDto> result = this.likeService.getLikeOfPost(this.samplePosts.get("post1").getPostId());
    ...
    void getLikeOfMember_success() {
        ...
        List<LikeDto> result = this.likeService.getLikeOfMember(this.sampleMembers.get("member1").getId());
    ...
    void cancelLike_success() throws SQLException {
        ...
        LikeDto like = this.likeService.getLike(generatedId);
